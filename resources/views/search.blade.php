                                    ...
                                    <div class="d-flex justify-content-between mb-3 nav nav-pills" style="font-size: 0.75rem">
                                        ...
                                        <div class="d-flex hover-show-group">
                                            ...
                                            <div class="hover-show">
                                                <a class="btn btn-sm float-end font-work-sans text-muted" href="https://www.simbrief.com/system/dispatch.php?orig={{ $airport->icao }}&dest={{ $airport->icao }}" target="_blank">
