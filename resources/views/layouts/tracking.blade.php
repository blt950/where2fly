@if(config('app.env') == 'production')
    ...
    <script defer src="https://umami.blt950.com/script.js" data-website-id="2e068f9a-3125-41cd-aeba-b1cd74f20fd4"></script>
@else
    ...
    <script defer src="https://umami.blt950.com/script.js" data-website-id="f9d5bb7d-b528-4c7c-8a85-5a401136ee29"></script>
@endif
