...
@section('content')
    ...
    <div class="container">
        ...
        <div class="text-start">
            ...
            <p>"remember_web_xxxxxx" is a cookie that remembers your login so you don't need to login each day.</p>
            ...
            <p>We use local storage on your device to save the map position for your convenience. This data is stored locally on your device and is not transmitted to our servers or shared with any third parties.</p>
            ...
            <p><strong>Legal Basis for Processing:</strong> Your data is processed based on your consent when creating an account and our legitimate interest in providing a secure, functional service.</p>
