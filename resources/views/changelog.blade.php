...
@section('content')
    ...
    <div class="container">
        <div class="text-start">
            ...
            <ul>
                <li>Fixed long named lists in map options breaking the design</li>
            </ul>

            <h2 class="mb-0">v3.1.2</h2>
            <span class="badge ps-0 pb-2">2026-09-01</span>
            <ul>
                <li>Fixed miscellaneous frontend errors</li>
            </ul>
            ...
            <ul>
                <li>Stability fixes for METARs and flights data fetching</li>
            </ul>

            <h2 class="mb-0">v2.7.3</h2>
            <span class="badge ps-0 pb-2">2026-02-03</span>
            <ul>
            ...
            <h2 class="mb-0">v2.6.3</h2>
            <span class="badge ps-0 pb-2">2025-09-14</span>
            <ul>
                <li>Fixed an issue where search didn't work when using adblock</li>
            </ul>

            <h2 class="mb-0">v2.6.2</h2>
            <span class="badge ps-0 pb-2">2025-08-09</span>
            <ul>
                <li>Fixed an issue with search without weather parameters throwing an error</li>
            </ul>
            ...
            <ul>
                <li>Fixed registration and emails throwing errors</li>
                <li>Fixed rare weather data issues</li>
                <li>Improved text for some errors and messages</li>
            </ul>
            ...
            <ul>
                ...
                <li>Fixed API authentication issues</li>
            ...
            <ul>
                <li>Fixed aircraft selector placeholder text</li>
                <li>Security updates</li>
            </ul>
