...
@section('content')
    ...
    <div class="container">
        ...
        <div class="d-block d-md-none bg-warning p-3">
            <p class="text-black m-0"><i class="fa-sharp fa-exclamation-triangle"></i> Scenery map is only available on desktop or tablet.</p>
        </div>
            ...
            <div class="d-none d-md-block mb-4">
                <div class="filterbox">
                    <span class="m-0"><strong class="d-block">Map Filter</strong>
                        ...
                        @foreach($availableSimulators->sortBy('order') as $simulator)
