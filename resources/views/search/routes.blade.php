                        ...
                        @foreach($routes as $route)
                            <tr>
                                <td data-sort="{{ $route->flight_icao }}">
                                    ...
                                    <div class="dropdown fs-6 text-info link-underline-info link-underline-opacity-25-hover ps-0">
                                        <button class="btn btn-xs btn-xs-light dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">{{ $route->flight_icao }}</button>
