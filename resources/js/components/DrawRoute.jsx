  ...
  useEffect(() => {
    const drawRoute = () => {
      ...
      if (window.innerWidth > 1920) {
        map.flyToBounds(newRoutePath.getBounds(), { duration: 0.35, minZoom: 3, maxZoom: 7, paddingTopLeft: [400, 350], paddingBottomRight: [75, 50] });
      } else {
        map.flyToBounds(newRoutePath.getBounds(), { duration: 0.35, minZoom: 3, maxZoom: 7, paddingTopLeft: [50, 350], paddingBottomRight: [50, 50] });
      }
